        ...
        <div className="mb-1 text-center">
          ...
          <div className="items-center px-4 py-3">
            <button
              onClick={handleClick}
              id="ok-btn"
              className="uppercase px-4 py-2 bg-green-500 text-white text-base font-medium rounded-md w-full shadow-sm hover:bg-green-600 hover:scale-105 hover:duration-200 focus:outline-none focus:ring-2 focus:ring-green-300 active:bg-green-700 active:text-white"
            >
              {buttonLabel}
            </button>
          </div>
